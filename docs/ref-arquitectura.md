...
(`setup.ps1` usa el mismo patrón con un subconjunto: `@('Log','Config','Context','Console','Exec','Job','Tools')` — `Job` solo por `Get-CvProcesoPatterns` para la limpieza de `Proceso\`.)
