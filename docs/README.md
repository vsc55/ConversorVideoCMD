...
| [explica-calidad.md](explica-calidad.md) | **Control de calidad** de la salida vs origen (`encode.qualityCheck`): diferencia entre **SSIM** (rápido, 0-1, estructural) y **VMAF** (perceptual de Netflix, 0-100, requiere `libvmaf`), cuándo usar cada uno y cómo se mide. |
