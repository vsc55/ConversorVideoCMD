@echo off
REM Lanzador de LimpiarBorde.ps1 sin tener que tocar la ExecutionPolicy del sistema.
...
chcp 65001 >nul
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0LimpiarBorde.ps1" %*
echo.
pause
